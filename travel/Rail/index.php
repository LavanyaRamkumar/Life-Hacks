...
<h2 class="containh2">From:</h2>
<select name="from">
<?php
$connect = mysqli_connect("localhost","root","","LifeHacks");
$query1="SELECT * FROM travel_railway_station";
...
echo"</select></br>";
echo"<h2 class=\"containh2\">To:</h2>";
echo"<select name='to'>";
$query2="SELECT * FROM travel_railway_station";
...
echo"</select></br>";
echo"<h2 class=\"containh2\">Date:</h2>";
echo"<select name='date'>";
$query3="SELECT * FROM travel_railway_t_travel";
...
function run(){
	...
	window.location = "http://localhost/DBMS_PROJECT/travel/rail/check1.php";
}
</script>
</body>
</html>
