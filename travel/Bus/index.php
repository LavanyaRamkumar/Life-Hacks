...
$query1="SELECT * FROM travel_bus_bus_station";
...
echo"<select name='to'>";
$query2="SELECT * FROM travel_bus_bus_station";
...
$query3="SELECT * FROM travel_bus_b_travel";
...
function run(){
	...
	window.location = "http://localhost/DBMS_Project/travel/Bus/check13.php";
}
</script>
</body>
</html>
